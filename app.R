# ==============================================================================
# PEŁNY KOD APLIKACJI SHINY (Zaliczenie - Projekt PJM)
# ==============================================================================

# 1. Instalacja pakietów (odkomentuj jeśli któregoś brakuje)
...
ui <- page_sidebar(
  title = "Instagram PJM Network Analyzer",
  ...
  navset_card_underline(
    ...
    # Zakładka 2: Hashtagi (Tu był wcześniej problem - teraz naprawione!)
